...
<?php $form=$this->beginWidget('CActiveForm', [
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'page_id',Page::all(),['empty'=>'']); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'user_id'); ?>
		<?php echo $form->dropDownList($model,'user_id',User::all(),['empty'=>'']); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'guest'); ?>
		<?php echo $form->textField($model,'guest', ['size'=>30,'maxlength'=>30]); ?>
	</div>
