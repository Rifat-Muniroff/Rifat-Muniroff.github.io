...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return [
			...
			['email','email'],
			['username','match','pattern'=>'/^([A-Za-z0-9 ]+)$/u','message'=>'Допустимые символы: A-Z, a-z, 0-9.'],
			['created, ban, role', 'numerical', 'integerOnly'=>true],
			...
			['id, username, password, created, ban, role, email', 'safe', 'on'=>'search'],
		];
	}
	...
	public function beforeSave()
	{
		...
		$this->password = md5('sdgdahfdh'.$this->password);
